...
if s:configuration.enable_italic
  ...
  call s:HL('Conditional', s:palette.darkblue, s:palette.none, 'italic')
  call s:HL('Repeat', s:palette.darkblue, s:palette.none, 'italic')
  ...
  call s:HL('Conditional', s:palette.darkblue, s:palette.none)
  call s:HL('Repeat', s:palette.darkblue, s:palette.none)
